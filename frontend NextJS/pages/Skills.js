...
const Skills = ({ others, frontend, backend }) => {
  ...
  return (
    <div className='sm:pt-[6rem] pt:5 mx-5 sm:mx-10 md:mx-12 lg:mx-16 xl:mx-20 min-h-[100vh] ' id='Skills'>
      ...
      <Title mainTitle="Skills & Technology" smallTitle="Explore New Technologies for efficiency, always looking for ways to solve the problem as efficiently as possible."></Title>
