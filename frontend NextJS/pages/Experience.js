...
const Experience = ({ experience, education, certification }) => {
  ...
  return (
    <section id="Experience" ref={experienceRef} className='sm:py-[6rem] py:5 min-h-[100vh] mx-5 sm:mx-10 md:mx-12 lg:mx-16 xl:mx-20'>
      ...
      <Title mainTitle="Experience" smallTitle="⚡Coding is like maths,the only way to learn it is practice. You can`t memorize it.⚡"></Title>
