...
const Project = ({ project, websiteprojects, webapplicationprojects }) => {
    ...
    return (
        <div id='Projects' ref={projectRef} className='sm:py-[6rem] py:5 overflow-x-hidden overflow-y-clip mx-5 sm:mx-10 md:mx-12 lg:mx-16 xl:mx-20 min-h-[100vh]'>
            ...
            <Title mainTitle="Projects" smallTitle="You don't have to do perfect things, you have to just try to make it perfect and at the end it will"></Title>
...
export async function getServerSideProps() {
    ...
    return {
        props: {
            project, websiteprojects, webapplicationprojects
