...
const Sidebar = () => {
  ...
  return (
    <div className="fixed w-[100%] z-50 flex items-center justify-between px-[2rem] md:px-[5rem] lg:px-[10rem] py-[2rem] text-white h-[5rem]  bg-white dark:bg-transparent bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 border-purple-100">

      <div className="flex items-center gap-3 md:-ml-[2rem] justify-center cursor-move">
        <img src="/logo.png" alt="HK" className="h-10 w-10" />
      </div>
      ...
      <div className='flex text-center items-center justify-center text-black dark:text-white '>
